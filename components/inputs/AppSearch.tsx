...
const AppSearch = ({ value, onChangeText, isHome, style }: AppSearchProps) => {
    return (
        ...
        <View
            width={'100%'}
            style={[style, { borderRadius: 8, borderColor: '#C9C9C9', borderWidth: 1, overflow: 'hidden' }]}
        >
            <BlurView intensity={190} style={{ width: '100%', height: 55, paddingHorizontal: 10, alignSelf: 'center', alignItems: 'center', flexDirection: 'row', }}>
                ...
                {isHome ?
                    ...
                    >
                        <View flex marginL-10>
                            <Text h3 gray>Tìm kiếm mỹ phẩm, liệu trình ...</Text>
                        </View>
                    </Pressable>
                    :
                    <TextField
