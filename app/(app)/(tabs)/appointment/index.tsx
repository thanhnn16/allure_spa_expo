...
const { t } = useLanguage();
  ...
  // Replace the renderFlatListItem function with:
        ...
        <View flex paddingH-24 marginT-10>
          {loading ? (
            ...
            <FlatList
              ...
              keyExtractor={useCallback((item: AppointmentResponeModelParams) => item.id.toString(), [])}
